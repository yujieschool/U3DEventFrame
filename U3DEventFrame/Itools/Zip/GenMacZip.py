...
def   Main():
      ...
      print ("main coming"+appDataPath)
      target = "StreamingAssets"

      RemoveMetaPath(appDataPath)
      ChangeName(appDataPath)

      disPath = os.getcwd()+"/tmp/"
