...
JITPath= currentPath +"LuaEncoder\\luajit"



winStreamAssetPath = currentPath+ "Assets\\StreamingAssets\\Lua\\Windows"

androidStreamAssetPath= currentPath+ "Assets\\StreamingAssets\\Lua\\Android"
...
def   JitCompile(filePath,file,frontPath):
  ...
  commond ="luajit.exe -b   %s  %s"%(file,outPath)
