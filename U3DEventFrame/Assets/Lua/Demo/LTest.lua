...
function LTest:New() 
    ...
    setmetatable(self, LTest);  --将self的元表设定为Class
...
function LTest.GetResourceBack(scence, bundle, reses, objes)
...
-- 这里面 就是做一些 事件的处理
function  LTest:ProcessEvent(msg)
