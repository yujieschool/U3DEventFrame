...
function Test:New() 
    ...
    setmetatable(self, Test);  --将self的元表设定为Class
...
function LChoosePlayer.GetResourceBack(scence, bundle, reses, objes)
...
-- 这里面 就是做一些 事件的处理
function  Test:ProcessEvent(msg)
