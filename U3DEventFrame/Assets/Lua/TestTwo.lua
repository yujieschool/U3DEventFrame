...
function TestTwo:New() 
    local self = {};    --初始化self，如果没有这句，那么类所建立的对象改变，其他对象都会改变
    setmetatable(self, TestTwo);  --将self的元表设定为Class
...
function TestTwo.GetResourceBack(scence, bundle, reses, objes)
...
-- 这里面 就是做一些 事件的处理
function  TestTwo:ProcessEvent(msg)
