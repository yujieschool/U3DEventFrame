...
public class TestUIAMsg  :MsgBase

{

    public GameObject ower;

    public   void  ChangeMsg(GameObject  tmpOwer,ushort tmpId)
    {
...
public class TestUI : UIBase
{
    public override void ProcessEvent(MsgBase msg)
    {
        switch (msg.msgId)
        {
            case (ushort)TestUIEvent.Initial:
                {

                    Debug.Log("Test UI  evnent  coming!!");
    ...
    void Awake()
    {
        ...
        msgIds = new ushort[] {
            ...
            (ushort)TestUIEvent.Initial ,

            (ushort)TestUIEvent.GetResource,
