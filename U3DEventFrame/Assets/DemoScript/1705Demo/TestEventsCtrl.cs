...
public class TestEventsCtrlModle
{
 

}

public class TestEventsCtrlCtrlLogic
{
 

}

public class TestEventsCtrl : UIBase
{
    ...
    TestEventsCtrlModle eventCSClassModle;

    TestEventsCtrlCtrlLogic eventCSClassCtrlLogic;
    ...
    void Awake()
    {
        ...
        eventCSClassModle = new TestEventsCtrlModle();

        eventCSClassCtrlLogic = new TestEventsCtrlCtrlLogic();
