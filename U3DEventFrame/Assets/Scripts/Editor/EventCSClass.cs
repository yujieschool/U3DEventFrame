...
public class EventCSClassModle
{
 

}

public class EventCSClassCtrlLogic
{
...
public class EventCSClass : UIBase
{
    ...
    EventCSClassModle eventCSClassModle;

    EventCSClassCtrlLogic eventCSClassCtrlLogic;
    ...
    void Awake()
    {
        ...
        eventCSClassModle = new EventCSClassModle();

        eventCSClassCtrlLogic = new EventCSClassCtrlLogic();
